...
SQL> GRANT SELECT ON administrator.clubs TO app_manager_role;

Grant succeeded.

SQL> GRANT SELECT ON administrator.players TO app_manager_role;

Grant succeeded.

SQL> GRANT UPDATE (club_stadium) ON administrator.clubs TO app_manager_role;

Grant succeeded.

SQL> GRANT UPDATE (player_ovr) ON administrator.players TO app_manager_role;
...
SQL> UPDATE administrator.clubs SET club_name = 'FC Base' WHERE club_id = 1;
UPDATE administrator.clubs SET club_name = 'FC Base' WHERE club_id = 1
                     *
ERROR at line 1:
ORA-01031: insufficient privileges

SQL> UPDATE administrator.clubs SET club_stadium = 'Stade de France' WHERE club_id = 5;
...
SQL> UPDATE administrator.players SET player_trait = 'Finesse Shot' WHERE player_name = 'Lionel Messi';
UPDATE administrator.players SET player_trait = 'Finesse Shot' WHERE player_name = 'Lionel Messi'
                     *
ERROR at line 1:
ORA-01031: insufficient privileges

SQL> UPDATE administrator.players SET player_ovr = 90 WHERE player_name = 'Kevin De Bruyne';
