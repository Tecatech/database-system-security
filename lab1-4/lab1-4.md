...
SQL> CREATE TABLE players(
  ...
  6      player_ovr NUMBER(2, 0),
  7      player_age NUMBER(2, 0),
...
SQL> SELECT *
 ...
 12              ) MR
 13      INNER JOIN players
 14      ON MR.player_id = players.player_id
 15      ORDER BY match_number;
...
SQL> SELECT *
 ...
 18              ) MR
 19          INNER JOIN players
 20          ON MR.player_id = players.player_id
 21          ORDER BY
 22              MR.player_id,
 23              MR.start_tstamp;
...
Connected.
SQL> GRANT
  2      CREATE ATTRIBUTE DIMENSION,
  3      CREATE HIERARCHY,
  4      CREATE ANALYTIC VIEW
  5  TO tecatech_lab1_4;
...
SQL> SELECT
  ...
  4      year,
  5      member_name,
  6      member_unique_name,
  7      member_caption,
  8      member_description
  9  FROM time_hier
 10  ORDER BY hier_order;
...
SQL> SELECT
  ...
  7      is_leaf,
  8      market_values,
  9      market_values_prior_period,
 10      market_values_chg_prior_period
 11  FROM market_values_av
 12  ORDER BY hier_order;
